...
class CoachStudentTestPage extends StatefulWidget {
  ...
  @override
  State<CoachStudentTestPage> createState() => _CoachStudentTestPageState();
}

class _CoachStudentTestPageState extends State<CoachStudentTestPage> {
  ...
  Widget _continueButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        ...
        // para guardar el resultado cuando se conecte
