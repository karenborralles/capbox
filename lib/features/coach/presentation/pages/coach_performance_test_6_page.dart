...
class CoachPerformanceTest6Page extends StatelessWidget {
  const CoachPerformanceTest6Page({super.key});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    '(Número de saltos de cuerda realizados en un minuto)',
  ...
  Widget _instructionBox() => Container(
        ...
        child: const Text(
          'Cuente cuantos saltos limpios de cuerda realiza el alumno en 60 segundos.',
  ...
  Widget _continueButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        ...
        context.go('/coach-performance-test-7'); 
      },
