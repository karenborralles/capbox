...
class CoachPerformanceTest7Page extends StatelessWidget {
  const CoachPerformanceTest7Page({super.key});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _pill('Flexiones en 60 segundos'),
  ...
  Widget _instructionBox() => Container(
        ...
        child: const Text(
          'Contar flexiones correctamente realizadas en un minuto.'
          '(Descansar un minuto despues de esto)',
  ...
  Widget _continueButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        ...
        context.go('/coach-performance-test-8'); 
      },
